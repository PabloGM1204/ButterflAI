...
# Cargar las URLs de las polillas desde el JSON generado previamente
with open("urls_moths.json", "r", encoding="utf-8") as f:
...
# Función para extraer información de cada polilla
...
# Lista para almacenar los datos de las polillas
butterfly_data = []
...
with open("polillas.json", "w", encoding="utf-8") as f:
    json.dump(butterfly_data, f, ensure_ascii=False, indent=4)

print("\n✅ Los datos de las polillas se han guardado en 'polillas.json'")
